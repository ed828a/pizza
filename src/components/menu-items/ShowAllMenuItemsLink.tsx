  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 xs:min-w-[320px] md:min-w-[512px] mx-auto">
      <div className="group ">
        <Link
          href={"/menu-items"}
          className="flex justify-center gap-8 w-full text-gray-700 group-hover:text-primary font-semibold border border-gray-300 group-hover:border-primary rounded-xl px-6 py-2 dark:text-gray-300"
        >
          ...
          <span className="">Show all menu items</span>
        </Link>
      </div>
      <div className="flex gap-4">
        <div className="group">
          <Link
            ...
            className="flex justify-center gap-2 w-full text-gray-700 font-semibold border border-gray-300 group-hover:border-primary rounded-xl px-6 py-2 dark:text-gray-300"
          >
        ...
        <div className="group">
          <Link
            ...
            className="flex justify-center gap-2 w-full text-gray-700 font-semibold border border-gray-300 rounded-xl px-6 py-2 group-hover:border-primary dark:text-gray-300 "
          >
