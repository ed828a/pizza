...
// import { Size } from "./MenuItemForm";
// import Up from "../icons/up";
// import Down from "../icons/down";
// import { cn } from "@/libs/utils";
// import { ItemStateType } from "./MenuItemDetailsContent";
...
Props) => {
  ...
  const addSize = ({ name, price }: AddonType) => {
    setSizes((prev: any[]) => [...prev, { name, price }]);
  };
  ...
  return (
    <div className="bg-gray-200 p-2 rounded-md mb-2">
      ...
      <div className={cn({ hidden: !isOpen })}>
        {sizes?.length > 0 &&
          sizes.map((size: AddonType, index) => (
