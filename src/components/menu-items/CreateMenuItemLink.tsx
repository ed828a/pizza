  ...
  return (
    <div className="group ">
      <div className="xs:min-w-[320px] md:min-w-[512px] mx-auto">
        ...
        >
          <span className="group-hover:text-primary dark:text-gray-300">
            Create new menu item
          </span>
          <ArrowRightIcon className="w-6 h-6 border-2 rounded-full border-gray-400 group-hover:border-primary group-hover:text-primary dark:text-gray-300 " />
        </Link>
      </div>
    </div>
  );
