...
import CreateEditSize from "./CreateEditSize";
import DeleteDialog from "../share/DeleteDialog";
import { deleteOneExtraIngredient, deleteOneSize } from "@/lib/categoryActions";
...
const SizesContent = ({ sizes }: Props) => {
  ...
  return (
    <div>
      ...
      <CreateEditSize
        ...
        setFocusedSize={setFocusedSize}
      />
      <div className="mt-16">
        <h5 className="text-gray-500 capitalize">Available sizes</h5>
